...
```typescript
import { IndexedDBPersistenceBackend } from '@lifo/core';
...
```typescript
import { Kernel, PersistenceBackend } from '@lifo/core';
import type { SerializedNode } from '@lifo/core';
...
See the [Kernel API reference](/api-reference/kernel) for details on the persistence system internals.
