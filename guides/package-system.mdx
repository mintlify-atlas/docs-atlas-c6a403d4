...
- Command: [lifo.ts:1-488](/api-reference/commands/lifo)
- Runtime: [lifo-runtime.ts](/api-reference/pkg/lifo-runtime)
- Dev links: [lifo-dev.ts](/api-reference/pkg/lifo-dev)

## API Reference

For complete API details, see:
- [CommandContext API](/api-reference/command-context)
- [LifoAPI](/api-reference/lifo-api)
